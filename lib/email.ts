          ...
          <div class="content">
            ...
            <div class="order-card">
              ...
              <div class="order-detail">
                ...
                <span class="value">${data.itemCount} items</span>
              </div>
              <div class="order-detail">
                <span class="label">Total Amount:</span>
                <span class="value">₹${data.total.toLocaleString('en-IN')}</span>
              </div>
              ${data.trackingNumber ? `
              <div class="order-detail">
          ...
          <div class="content">
            ...
            <div style="background: #DCFCE7; border-left: 4px solid #16A34A; padding: 20px; border-radius: 8px; margin: 30px 0;">
              ...
              <p style="color: #166534; margin: 0; line-height: 1.6;">
                Your package has been delivered to: <strong>${data.shippingAddress.address}, ${data.shippingAddress.city}</strong>
              </p>
            </div>
